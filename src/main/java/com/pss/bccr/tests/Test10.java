 ...
 */
@Component
public class Test10 implements ITests {
	 ...
	 * 
	 * @El Hash enviado del documento no coincide con el hash calculado.
	 * 
	...
	public int test() throws Exception {
		...
		{ // message payload
			...
			value.setHashDocumento(ITests.hash(ITests.b64encode(pdfbytes)));
