 ...
 */
@Component
public class Test09 implements ITests {

	private static final Logger logger = LoggerFactory.getLogger(Test09.class);
	...
	public int test() throws Exception {
		...
		{ // message payload
			...
			final byte[] pdfbytes = ITests.load(getClass().getResource(SAMPLE_DOC_FILE));
