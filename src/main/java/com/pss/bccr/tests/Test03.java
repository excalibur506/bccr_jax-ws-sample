 ...
 */
@Component
public class Test03 implements ITests {
	 ...
	 * 
	 * @Existe una diferencia no permitida entre la fecha y hora del cliente y la
	 *         del servidor.
	 * 
	...
	public int test() throws Exception {
		...
		{ // message payload
			...
			value.setFechaDeReferenciaDeLaEntidad(ITests.xmlBadTime());
