 ...
 */
@Component
public class Test06 implements ITests {

	private static final Logger logger = LoggerFactory.getLogger(Test06.class);
	 ...
	 * 
	 * @La identidad de marca no pertenece a la entidad solicitante
	 * 
	...
	public int test() throws Exception {
		...
		{ // message payload
			...
			value.setCodNegocio(codigoNegocio * 1010);
